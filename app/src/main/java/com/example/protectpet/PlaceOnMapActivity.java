...
import com.example.protectpet.models.Location;
...
public class PlaceOnMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void showDistance() {
        LatLng destinationPosition = new LatLng(Double.parseDouble(location2.getLat()), Double.parseDouble(location2.getLng()));
