package com.example.protectpet.adapter;
...
import com.example.protectpet.MessageActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    private void lastMessage(final String userid, final TextView last_msg){
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance("https://cse499-3dd6a-default-rtdb.firebaseio.com/").getReference("Chats");
